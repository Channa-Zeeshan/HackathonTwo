...
const Email = () => {
  return (
    <div className='font-thin block overflow-auto max-w-[1440px] m-auto'>
        <div  className='w-full max-h-[444px] relative lg:max-w[1440px] lg:max-h[244px] flex justify-center'>
            <div className='absolute top-0 -z-10'>
                <Image src={signup} alt='signup' className=' object-cover  max-h-[444px] '></Image>

            </div>
            <div className='flex   item-center justify-between md:justify-center flex-col  md:py-16 max-h-[444px]'>
